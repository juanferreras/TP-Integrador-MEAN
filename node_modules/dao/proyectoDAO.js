...
module.exports = {
  ...
  validarCliente: function(idProyectoActual, idCliente, callback){
    dbConn.conectar(function(db){
      db.collection(coleccionSelecc).
      find({ $and: [ 
              { "cliente._id": { $eq: idCliente } }, 
              { _id: { $ne: ObjectId(idProyectoActual) } } 
            ]
